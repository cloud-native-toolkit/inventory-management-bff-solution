...
import {StockItem, StockItemsApi} from '../../src/services';
import {RequestOptions, ResponseOptions} from '@pact-foundation/pact/dsl/interaction';
...
describe('stock-items.service', () => {
  ...
  beforeEach(() => {
    Container.bind(StockItemServiceConfig).provider({get: () => ({
  ...
  context('given listStockItems()', () => {
    context('when called', () => {
      const expectedResult: StockItem = {
        id: '1234',
